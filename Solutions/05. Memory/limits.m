...
Limit limits[] = {
    ...
    { RLIMIT_NOFILE,	"maximum number of simultaneously open files" },
    { RLIMIT_NPROC,	"maximum number of simultaneous processes" },
...
// right-justfity the first entry in a field width of 45, then display two
// more strings
